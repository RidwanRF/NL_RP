...
addEventHandler("onAssetsLoaded", getRootElement(),
	function ()
		if panelState or detailsState then
			...
			mainFont = exports.nlrp_assets:loadFont("CenturyGothicBold.ttf", respc(12), false, "cleartype")
			sarpFont = exports.nlrp_assets:loadFont("BebasNeue.otf", respc(18), false, "cleartype")
		end
	end
)

exports.nlrp_admin:addAdminCommand("fonts", 9, "Létrehozott betűtípusok adatai")
...
exports.nlrp_admin:addAdminCommand("performancelog", 7, "Játékos teljesítmény felmérés")
...
exports.nlrp_admin:addAdminCommand("performance", 7, "Teljesítmény statisztikák")
...
function dataRefresh()
	if detailsState then
		fontRows = exports.nlrp_assets:getFontsDetail()
		dataProcess()
