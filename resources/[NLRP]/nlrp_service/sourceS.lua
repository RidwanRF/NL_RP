addEvent("nlrp_serviceS:startService", true)
addEventHandler("nlrp_serviceS:startService", root, function(vehicle, component)
    setPedAnimation(source, "bomber", "bom_plant_loop", -1, true, false)

    triggerClientEvent(source, "nlrp_serviceC:startService", vehicle, component)
    print(component)
...
addEvent("nlrp_serviceS:repairComponent", true)
addEventHandler("nlrp_serviceS:repairComponent", root, function(vehicle, component)
