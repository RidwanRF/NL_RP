...
exports.nlrp_admin:addAdminCommand("deletebilliard", 7, "Biliárd asztal törlése")
	...
	function (give, stopAnim)
		if isElement(source) then
			if give then
				...
				exports.nlrp_controls:toggleControl(source, {"fire"}, false)
			else
				takeAllWeapons(source)
				exports.nlrp_controls:toggleControl(source, {"fire"}, true)
			end
