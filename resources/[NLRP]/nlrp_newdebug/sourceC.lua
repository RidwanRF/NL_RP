...
exports.nlrp_admin:addAdminCommand("cd", 9, "Debugscript ürítése")
...
exports.nlrp_admin:addAdminCommand("debugon", 9, "Debugscript bekapcsolása")
addCommandHandler("debugon",
	function ()
		if getElementData(localPlayer, "acc.adminLevel") >= 9 then
			if not debugscriptActive then
				Roboto = dxCreateFont(":nlrp_assets/fonts/Roboto-Regular.ttf", 14, false, "antialiased")
...
exports.nlrp_admin:addAdminCommand("debugoff", 9, "Debugscript kikapcsolása")
