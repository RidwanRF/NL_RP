...
addEvent("nlrp_sirenC:showSettings", true)
addEventHandler("nlrp_sirenC:showSettings", root, Settings.Show)
	...
	if button == "left" then
        ...
        elseif widget == widgets.saveButton then
            if isPedInVehicle(localPlayer) then
                ...
                --triggerServerEvent("nlrp_sirenS:toggleGPS", localPlayer, gpsState)
            end
