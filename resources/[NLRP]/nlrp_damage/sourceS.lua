				...
				if math.random(chance) <= 7 then
					...
					if not boneDamages[boneName] then
						...
						if boneName == "leftArm" then
							exports.nlrp_hud:showInfobox(source, "warning", "Eltört a bal karod!")
						elseif boneName == "rightArm" then
							exports.nlrp_hud:showInfobox(source, "warning", "Eltört a jobb karod!")
						elseif boneName == "leftLeg" then
							exports.nlrp_hud:showInfobox(source, "warning", "Eltört a bal lábad!")
						elseif boneName == "rightLeg" then
							exports.nlrp_hud:showInfobox(source, "warning", "Eltört a jobb lábad!")
						end
					end
				end
			end
