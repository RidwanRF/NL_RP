...
local BebasNeue = dxCreateFont(":nlrp_assets/fonts/BebasNeue.otf", util:resp(15))
local Century = dxCreateFont(":nlrp_assets/fonts/CenturyGothicRegular.ttf", util:resp(12))
...
function renderAchievementBox()
	...
	dxDrawImage(panelX + util:resp(10), panelY + util:resp(15), imageWidth, imageHeight, ":nlrp_assets/images/achievement/medal.png", 0, 0, 0, tocolor(255, 255, 255, 255 * fadeAlpha))
...
function showAchivementPanel(achievementID)	
    ...
    playSound(":nlrp_assets/audio/achievements/newach.ogg")
...
local roundTexture = dxCreateTexture(":nlrp_assets/images/alert/round.png", "argb", true, "clamp")
