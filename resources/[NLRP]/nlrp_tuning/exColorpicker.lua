...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow(screenW - info.selectWindow.width - 50, (screenH - info.selectWindow.height) / 2,
		                                       	256, 256, "Szín Választás", false)
		guiSetVisible(colorPicker.GUI.selectWindow, false)
		guiSetAlpha(colorPicker.GUI.selectWindow, 0)
		...
		colorPicker.GUI.palette = guiCreateStaticImage(colorPicker.selectWindow.paletteX, colorPicker.selectWindow.paletteY,
		                                        256, 256, "files/palette.png", false, colorPicker.GUI.selectWindow)
		colorPicker.GUI.alphaBar = guiCreateStaticImage(colorPicker.selectWindow.paletteX + 255 + colorPicker.selectWindow.alphaOffset, colorPicker.selectWindow.paletteY,
		                                        256, 256, "files/hoveredrow.png", false, colorPicker.GUI.selectWindow)
...
--This is where the color updates every time you click the palette or presets!
	...
	closeSelect = function()
		...
		closeColorpicker(colorPicker.value[1], colorPicker.value[2], colorPicker.value[3])
	end,
