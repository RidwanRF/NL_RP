...
addEventHandler("onClientRender", root, function()
	if pickerData and pickerData["colortype"] ~= nil and pickerData["active"] then
		...
		--> Color selector
		drawBorder(pickerData["posX"], pickerData["posY"]-25, pickerData["width"], pickerData["height"]+25, 2, tocolor(0, 0, 0, 255))
		dxDrawRectangle(pickerData["posX"], pickerData["posY"]-25, pickerData["width"], 25, tocolor(0, 0, 0, 170))
		dxDrawRectangle(pickerData["posX"], pickerData["posY"]+pickerData["height"]+22, pickerData["width"]+2, 3, tocolor(124, 197, 118, 255))
		dxDrawText("Színpaletta", pickerData["posX"]+5, pickerData["posY"]-25+22/2, pickerData["width"], pickerData["posY"]-25+22/2, tocolor(255, 255, 255, 255), 1 , "default-bold", "left", "center", false, false, false, true)
		dxDrawRectangle(pickerData["posX"], pickerData["posY"]-4, pickerData["width"], 3, tocolor(pickerData["selectedColor"][1], pickerData["selectedColor"][2], pickerData["selectedColor"][3], 255))
