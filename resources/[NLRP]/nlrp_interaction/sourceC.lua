...
--[[local test = {
    {"Bezárás", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}, "action"},
    {"Menü 2", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    {"Menü 3", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    {"Menü 4", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    {"Menü 5", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    --{"Menü 6", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    --{"Menü 7", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
    --{"Menü 8", ":nlrp_assets/images/sarplogo_big.png", {100, 100, 100}},
}--]]
...
Interaction.Panel = function(interactions)
    if interactionActive then
        ...
        if getElementType(selectedElement) == "vehicle" then
            local textW = dxGetTextWidth(exports.nlrp_vehs:getVehicleName(selectedElement), 1, fonts.Roboto14)
        ...
        if getElementType(selectedElement) == "vehicle" then
            dxDrawText(exports.nlrp_vehs:getVehicleName(selectedElement), panelX, panelY + respc(10), panelW + panelX, panelH + panelY, tocolor(255, 255, 255, 255), 1, fonts.Roboto14, "center", "top")
...
addEventHandler("onClientClick", root, function(button, state, absoluteX, absoluteY, worldX, worldY, worldZ, clickedElement)
    if button == "right" and state == "down" then
        if not interactionActive then
            ...
            if isElement(clickedElement) then
                if clickedElement ~= localPlayer then
                    if getElementData(clickedElement, "isInteractable") or getElementType(clickedElement) == "vehicle" or getElementType(clickedElement) == "player" then
                        if exports.nlrp_core:inDistance3D(clickedElement, localPlayer, getElementRadius(clickedElement) * 2) then
            ...
            exports.nlrp_alert:showAlert("error", "Előbb zárd be az interakció panelt")
        end
    elseif button == "left" and state == "down" then
        if interactionActive then
            for i = 1, #elementInteractions do
                if activeButton == "interaction:" .. i then
                    playSound(":nlrp_assets/audio/interface/click.ogg")
