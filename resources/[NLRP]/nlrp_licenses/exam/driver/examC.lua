...
function renderExamPanel()
	...
	--dxDrawImage(math.floor(examX + 3), math.floor(examY + 3), 24, 24, ":nlrp_hud/files/logo.png", 0, 0, 0, tocolor(183, 255, 0))
    ...
    if page == "main" then
        ...
        dxDrawText("Egy rövidke tesztben kérdésekre kell válaszolnod, amennyiben sikeresen teljesitsed a vizsgát egy B kategóriás jogosítvánnyal leszel gazdagabb. ((A panel megnyitása utánn nézz el az NPC ről, mivel ha ujra rákattintasz ujrakezdi a vizsgát.))", examX + 10, examY + 40, examW + examX - 10, examH + examY, tocolor(255, 255, 255, 255), 1, fonts.Roboto13, "center", "center", false, true)

        local buttonW, buttonH = respc(220), respc(40)

        dxDrawMetroButtonWithBorder("exam:theory:start", "Elméleti vizsga elkezdése", examX + (examW - buttonW) * 0.5, examY + examH - 10 - buttonH, buttonW, buttonH, {183, 255, 0, 125}, {183, 255, 0, 175}, {255, 255, 255}, fonts.Roboto13, "center", "center", nil, nil, nil, nil)
    ...
    elseif page == "test" then
        ...
        for k, v in pairs(questions[currentQuestion]["answers"]) do
            ...
            dxDrawMetroButtonWithBorder("exam:answer:" .. k, v, buttonX, buttonY, buttonW, buttonH, {183, 255, 0, 125}, {183, 255, 0, 175}, {255, 255, 255}, fonts.Roboto12, "center", "center", nil, nil, nil, nil)
        end
    elseif page == "result" then
            ...
            if examSuccess then
                ...
                dxDrawText("Az ön ponszáma elérte a szükséges pontszámot! Az igazoló papírt átadtuk önnek. A továbbiakban fáradjon be a városházára és váltsa ki vezetői engedélyét.", examX + 10, examY + 40, examW + examX - 10, examH + examY, tocolor(255, 255, 255, 255), 1, fonts.Roboto13, "center", "center", false, true)
            else
