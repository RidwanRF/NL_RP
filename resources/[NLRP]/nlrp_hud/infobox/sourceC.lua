alertTypes = {
	info = {"Információ", ":nlrp_assets/images/alert/info.png", {183,255,0}, ":nlrp_assets/audio/alert/bulle.wav"},
	jail = {"Adminbörtön", ":nlrp_assets/images/alert/ajail.png", {233, 30, 99}, ":nlrp_assets/audio/alert/star.wav"},
	kick = {"Kirúgás", ":nlrp_assets/images/alert/akick.png", {218, 147, 44}, ":nlrp_assets/audio/alert/star.wav"},
	ban = {"Kitiltás", ":nlrp_assets/images/alert/aban.png", {218, 44, 73}, ":nlrp_assets/audio/alert/star.wav"},
	error = {"Hiba", ":nlrp_assets/images/alert/error.png", {200, 50, 50}, ":nlrp_assets/audio/alert/error.wav"},
	warning = {"Figyelmeztetés", ":nlrp_assets/images/alert/warning.png", {255, 128, 0}, ":nlrp_assets/audio/alert/error.wav"}, 
	aduty = {"Adminszolgálat", ":nlrp_assets/images/alert/aduty.png", {183,255,0}, ":nlrp_assets/audio/alert/victory.wav"},
	success = {"Információ", ":nlrp_assets/images/alert/success.png", {50, 200, 50}, ":nlrp_assets/audio/alert/star.wav"}
}
