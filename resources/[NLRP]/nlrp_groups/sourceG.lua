...
--	unlockVehicle = "Jármű kinyitás",
	...
	border = "Határ információk", -- Kész
	repair = "Autószerelés", -- Kész
	MDCPD = "MDC jogosultság (PD)", -- Kész
	MDCNAV = "MDC jogosultság (NAV)",-- Kész
	traffipax = "Traffipax",-- Kész
	bankrob = "Bankrablás",-- Kész
	WeaponTrans = "WeaponTrans",-- Kész
	DrogTrans = "DrogTrans",-- Kész
}
