local settings = {
	driver = get"" or { 0 },
	passenger = get"driveby_passenger" or { 207,23,24,25,26,28,29,32,30,31,33 },
	shotdelay = get"driveby_shot_delay" or { ['207']=300,['23']=300,['24']=800,['26']=700 },
...
local validDrivebyWeapons = { [207]=true,[23]=true,[24]=true,[25]=true,
