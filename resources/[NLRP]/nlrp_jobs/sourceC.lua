...
local reponsiveMultipler = exports.nlrp_hud:getResponsiveMultipler()
...
local bebas15 = dxCreateFont(":nlrp_assets/fonts/BebasNeue.otf", resp(15))
local bebas20 = dxCreateFont(":nlrp_assets/fonts/BebasNeue.otf", resp(20))
local century13 = dxCreateFont(":nlrp_assets/fonts/CenturyGothicRegular.ttf", resp(13))
local century16 = dxCreateFont(":nlrp_assets/fonts/CenturyGothicRegular.ttf", resp(16))
...
addEventHandler("onClientRender", root, function()
    if showJobPanel then
        ...
        dxDrawRectangle(eButtonX, eButtonY, eButtonW, eButtonH, tocolor(183, 255, 0, 230))
        ...
        if #jobs > jobsVisible then
            ...
            dxDrawRectangle(scrollBarX, scrollBarY + scrollbarPosition, scrollBarW, (scrollbarCalculatedHeight * jobsVisible) - scrollBarH * 0.5, tocolor(183, 255, 0, 230))
        end
            ...
            if v then
                ...
                if cursorInBox(imageX, imageY, imageW, imageH) then
                    ...
                    if tonumber(getElementData(localPlayer, "char.Job") or 0) == tonumber(selectedJob) then
                        ...
                        dxDrawRectangle(buttonX, buttonY, buttonW, buttonH, tocolor(183, 255, 0, 160)) -- 143, 67, 67
                        ...
                        if cursorInBox(buttonX, buttonY, buttonW, buttonH) then
                            if tonumber(getElementData(localPlayer, "char.Job") or 0) == tonumber(selectedJob) then
                                ...
                                if tonumber(getElementData(localPlayer, "char.playedMinutes")) >= jobs[selectedJob][4] then
                                    ...
                                    exports.nlrp_hud:showAlert("error", "A " .. jobs[selectedJob][1] .. " felvételéhez", "minimum " .. jobs[selectedJob][4] .. " játszott perc szükséges")
