...
addEventHandler("onClientRender", root, function()
	...
	dxDrawImage(math.floor(panelAnimsX + 3), math.floor(panelAnimsY + 3), 24, 24, ":nlrp_hud/files/logo.png", 0, 0, 0, tocolor(183, 255, 0))
...
addEventHandler("onClientClick", root, function(button, state)
	...
	if button == "left" and state == "down" then
		if activeButton == "anim:play" then
			local animsOffset = scrollData["animsOffset"] or 0
			triggerServerEvent("nlrp_animationS:playAnimation", root, localPlayer, selectedAnim)
		end
