...
function startJob()
	exports.nlrp_hud:showAlert("info", "Sikeresen elkezdted az ablaktisztítást!", "Várd meg a felvonót, majd kattints rá, és szálj be")
	createJobBlip()
	--createJobMarker()
    jobActive = true
end
...
function stopJob()
	exports.nlrp_hud:showAlert("info", "Befejezted az ablaktisztítást")
	destroyJobBlip()
	--destroyJobMarker()
...
addEventHandler("onClientRender", root, function()
	if showWindow then
		...
		dxDrawImage(hitX, hitY, hitS, hitS, ":nlrp_assets/images/jobs/miner/crosshair.png")
	end
...
function cleanWindow()
	...
	elseif windowA <= 0 then
		...
		if lastWindows == 0 then
			stopWindowCleaning()
			exports.nlrp_hud:showAlert("info", "Sikeresen megtisztítottad az ablakot!", "10$-t kaptál a munkádért.")
			return
		end
		exports.nlrp_hud:showAlert("info", "Sikeresen megtisztítottad az ablakot!", "10$-t kaptál a munkádért. Még " .. lastWindows .. " ablak van hátra.")
		movePlatform(math.random(1, buildingLevels))
	end
	generateHitPoint()
end
