...
addEventHandler("onClientResourceStart", getResourceRootElement(),
    function()
		...
		for i=1, 55 do
			...
			if(i == 25) then
				kreszid = 8081999 -- jobbra kanyarodni tilos    ----------       ---------------
			end
			if(i == 26) then
				kreszid = 8082999 -- balra kanyarodni tilos      --------------    -----------------
			end
			if(i == 27) then
				kreszid = 8083999 -- vám/zoll -----------
			end
			if(i == 28) then
				kreszid = 8084999 -- visszafordulni tilos     ----------------
			end
			if(i == 29) then
				kreszid = 8085999 -- 5 km/h ---------------------
			end
			if(i == 30) then
				kreszid = 8086999 -- 10 km/h ------------------
			end
			if(i == 31) then
				kreszid = 8087 -- 20 km/h
			end
			if(i == 32) then
				kreszid = 8134 -- 30 km/h
			end
			if(i == 33) then
				kreszid = 8201 -- 40 km/h
			end
			if(i == 34) then
				kreszid = 8245 -- 50 km/h
			end
			if(i == 35) then
			...
			if(i == 38) then
				kreszid = 8283 -- 90 km/h
			end
			if(i == 39) then
				kreszid = 8286 -- 100 km/h
			end
			if(i == 40) then
				kreszid = 8287999 -- 110 km/h -------------------------
			end
			if(i == 41) then
				kreszid = 8333 -- 120 km/h
			end
			if(i == 42) then
		...
		for i=1, 29 do
			...
			if(i == 5) then
				kreszid = 8508 -- kötelező haladási irány jobbra
			end
			if(i == 6) then
		...
		for i=1, 4 do
			...
			if(i == 1) then
				kreszid = 8591 -- autópálya
			end
			if(i == 2) then
				kreszid = 8593999 -- autópálya vége ---------------
			end
			if(i == 3) then
				kreszid = 8594999 -- autóút  ---------------
			end
			if(i == 4) then
				kreszid = 8595999 -- autóút vége ---------------
			end
...
--[[			if(i == 49) then
		...
		for i=1, 4 do
			...
			if(i == 2) then
				kreszid = 9066 -- elsőbbségadás kötelező
				dffneve = "kresz4"
			end
			if(i == 3) then
...
txd = engineLoadTXD ( "veda.txd" )
engineImportTXD ( txd, 9698 )
dff = engineLoadDFF ( "veda.dff" )
engineReplaceModel (9698)
col = engineLoadCOL ( "veda.col" )
engineReplaceModel (9698)